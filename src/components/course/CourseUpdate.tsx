                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Nhập mô tả..." {...field} className="h-[260px]" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <>
                                        <div className="h-[250px] bg-white border rounded-md border-gray-200 flex items-center justify-center relative">
                                            {!imageWatch ? (
                                                <UploadButton
